...
INSERT INTO PERSONS (FIRSTNAME, LASTNAME, UCN, PHONENUMBER, EMAIL, ADDRESS)
VALUES ('Daniel', 'Kostov', '3214124' , '0887565656', 'kostov@gmail.com', 'ul. Kaloqnski 5')

INSERT INTO PERSONS (FIRSTNAME, LASTNAME, UCN, PHONENUMBER, EMAIL, ADDRESS)
VALUES ('Boris', 'Petrov', '0123923' , '0889232323', 'borisp@abv.bg', 'ul. Smolensk 2')

INSERT INTO PERSONS (FIRSTNAME, LASTNAME, UCN, PHONENUMBER, EMAIL, ADDRESS)
VALUES ('Valentina', 'Naidenova', '987222' ,  '0887888888', 'v.naid@abv.bg', 'ul. Sv. Petka')

INSERT INTO PERSONS (FIRSTNAME, LASTNAME, UCN, PHONENUMBER, EMAIL, ADDRESS)
VALUES ('Ivan', 'Ivanov', '43546456' , '0889889898', 'vanko@mail.bg', 'ul. Vqrna 11')

--insert into accounts table
INSERT INTO ACCOUNTS(PERSON_ID, USERNAME, PASSWORD, ROLE_ID, RATING_ID) 
VALUES((SELECT ID FROM PERSONS WHERE UCN = '0123923'), 'slayer55', 'bibli22', (SELECT ROLE.ID FROM ROLE WHERE ROLE.ROLE = 'Admin'), (SELECT RATING.ID FROM RATING WHERE RATING = 5))

INSERT INTO ACCOUNTS(PERSON_ID, USERNAME, PASSWORD, ROLE_ID, RATING_ID) 
VALUES((SELECT ID FROM PERSONS WHERE UCN = '987222'), 'v.naidenova', 'vn1990biblioteka', (SELECT ROLE.ID FROM ROLE WHERE ROLE.ROLE = 'Operator'), (SELECT RATING.ID FROM RATING WHERE RATING = 5))

INSERT INTO ACCOUNTS(PERSON_ID, USERNAME, PASSWORD, ROLE_ID, RATING_ID) 
VALUES((SELECT ID FROM PERSONS WHERE UCN = '43546456'), 'vankata96', 'vankosumve1', (SELECT ROLE.ID FROM ROLE WHERE ROLE.ROLE = 'Reader'), (SELECT RATING.ID FROM RATING WHERE RATING = 3))
